...
// Keep the current page selected until less than this fraction of the
// viewport still shows it. Stops high-zoom scroll from masking the tail.
export const PAGE_SWITCH_REMAINING_RATIO = 0.25;
